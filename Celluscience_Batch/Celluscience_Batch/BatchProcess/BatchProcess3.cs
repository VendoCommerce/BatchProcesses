...
{
    public class BatchProcess3 : ConversionSystems.Celluscience.UI.BaseClass
    {
        static string key1;
        ...
        private DataTable OrderSKU
        {
            get
            {
                if (_dtOrderSKU == null)
                {
                    DAL.SQLServerDAL_Try.GetOrderSKU(_intOrderID, out _dtOrderSKU);
                }
                return _dtOrderSKU;
            }
        }
        ...
        private DataTable CustomerShippingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDAL_Try.GetCustomerAddress(_intShippingAddress, out _dtCustomerShippingAddress);
                }
        ...
        private DataTable CustomerBillingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDAL_Try.GetCustomerAddress(_intBillingAddress, out _dtCustomerBillingAddress);
                }
        ...
        public bool ProcessBatch(DateTime dtbp, string EmployeeNumber)
        {
            bool _breturn = false;
           // string DNIS = "5700";
            string DNIS = Helper.DataServicesTxtBatchConfig["Field#22_TRY"];   
            ...
            try
            {  
                DAL.SQLServerDAL_Try.GetOrdersForTxtBatch(dtbp, out _dtOrders);
                foreach (DataRow _drOrder in _dtOrders.Rows)
                {
                    ...
                    DAL.SQLServerDAL_Try.GetSalesTaxRate(ord.ShipToState, out _dtSalesTaxRate);
                    ...
                    // For TryCelluscience. MerchandiseTotal and shipping are hardcode and are not same as site. Please dont confuse.
                    if (IsMultiPay)
                    {
