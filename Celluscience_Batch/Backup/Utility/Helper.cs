...
namespace ConversionSystems.Celluscience.Utility
{
    public class Helper
    {
        ...
        public static NameValueCollection DataServicesTxtBatchConfig
        {
            get { return (NameValueCollection)ConfigurationManager.GetSection("DataServicesTxtBatchConfig"); }
        }
