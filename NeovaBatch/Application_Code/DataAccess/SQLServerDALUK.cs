...
{
    public class SQLServerDALUK : SQLServerDAO
    {
        SqlConnection _Connection = null;
        private const string _FILENAME = "SQLServerUK.cs";
        ...
        public bool GetRejectedOrdersForXMLBatch(out DataTable dt)
        {
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "GetUKRejectedOrders";
                oCmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool SendEamilConf(out DataTable dt)
        {
            bool bReturn = false;
            int intPhase = -1;
            string strMessage;
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "UKSendEmailConf";
                oCmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlConnection Connection
        {
            ...
            get
            {
                ...
                try
                {
                    this.ClearErrors();
                    intPhase = -1;
                    if (_Connection == null) { _Connection = new SqlConnection(Helper.SQLServerDAO["mode"].ToString()); }
                    intPhase = -2;
