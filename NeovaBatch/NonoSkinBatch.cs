...
namespace Com.ConversionSystems.GoldCanyon
{
    public class NonoBatch : Com.ConversionSystems.UI.BasePage
    {
        ...
        {
            SqlConnection conn = new SqlConnection(Helper.SQLServerDAO["NoNoSkin"].ToString());
            conn.Open();
        ...
        public void sendxml1(string verifyflag, string ordernumber)
        {
            ...
            string stb = "<LineItem lineNumber=[[[@1[[[>~<ItemCode>@2</ItemCode>~<Quantity>@3</Quantity>~<UnitPrice>@4</UnitPrice>~<Recurrence patternID=[[[@5[[[></Recurrence>~</LineItem>";
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                ...
                foreach (DataRow r1 in OrderSKU.Rows)
                {
                    ...
                    if (r1["skuid"].ToString().Equals("327") || r1["skuid"].ToString().Equals("330") || r1["skuid"].ToString().Equals("331") || r1["skuid"].ToString().Equals("332") || r1["skuid"].ToString().Equals("345") || r1["skuid"].ToString().Equals("347"))
                    {
                ...
                if (PaymentPlanSKU.Contains("340") || PaymentPlanSKU.Contains("341") || PaymentPlanSKU.Contains("344") || PaymentPlanSKU.Contains("345") || PaymentPlanSKU.Contains("346") || PaymentPlanSKU.Contains("347") || PaymentPlanSKU.Contains("349") || PaymentPlanSKU.Contains("351"))
                {
