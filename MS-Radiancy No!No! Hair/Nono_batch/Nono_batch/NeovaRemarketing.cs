...
{
    public class NeovaRemarketing : Com.ConversionSystems.UI.BasePage
    {
        ...
        private DataTable Orders
        {
            get
            {
                //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(DateTime.ParseExact (DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd",CultureInfo.InvariantCulture), out _dtOrders);
                DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(out _dtOrders);
                //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(DateTime.Now.AddDays(-1), out _dtOrders);
                //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(new DateTime(2009, 06, 29), out _dtOrders);
        ...
        private DataTable RejectedOrders
        {
            get
            {
                ...
                {
                    //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(DateTime.ParseExact (DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd",CultureInfo.InvariantCulture), out _dtOrders);
                    DAL.SQLServerDALNeovaRemarketing.GetRejectedOrdersForXMLBatch(out _dtRejectedOrders);
                    //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(DateTime.Now.AddDays(-1), out _dtOrders);
                    //DAL.SQLServerDALNeovaRemarketing.GetOrdersForXMLBatch(new DateTime(2009, 06, 29), out _dtOrders);
                }
        ...
        private DataTable CustomerBillingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDALNeovaRemarketing.GetCustomerAddress(_intBillingAddress, out _dtCustomerBillingAddress);
                }
        ...
        private DataTable CustomerShippingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDALNeovaRemarketing.GetCustomerAddress(_intShippingAddress, out _dtCustomerShippingAddress);
                }
        ...
        private DataTable OrderSKU
        {
            get
            {
                if (_dtOrderSKU == null)
                {
                    DAL.SQLServerDALNeovaRemarketing.GetOrderSKU(_intOrderID, out _dtOrderSKU);
                }
                return _dtOrderSKU;
            }
        }
        ...
        {
            using (SqlConnection conn = new SqlConnection(Helper.SQLServerDAO["Neova"].ToString()))
            {
                conn.Open();
        ...
        public string getomxml(string verifyflag, string orderid1)
        {
            ...
            s1 += "		    <Field fieldName=[[[FirstHear[[[></Field>~";
        ...
        public void sendxml1(string verifyflag, string ordernumber)
        {
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                ...
                s1 = s1.Replace("@orderid@", "NEOVARM" + fixstring(r["orderid"]));
        ...
        public static void sendEmailToAdmin(string desc, string orderid)
        {
            try
            {
                ...
                message.Subject = "Error processing order -  Neova.com-RM-" + orderid;
