...
namespace Com.ConversionSystems.GoldCanyon
{
    public class Ireland : Com.ConversionSystems.UI.BasePage
    {
        ...
        public string getomxml(string verifyflag, string orderid1)
        {
            ...
            s1 += "		<CardAuthCode>@CardAuthCode@</CardAuthCode>~";
            //s1 += "     <CardTransactionID>@CardConfCode@</CardTransactionID>~";
            //s1 += "     <CardAuthorizationAmount>@TotalAmount@</CardAuthorizationAmount>~";
        ...
        public void sendxml1(string verifyflag, string ordernumber)
        {
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                ...
                //s1 = s1.Replace("@CardConfCode@", _TransactionId);
                ...
                foreach (DataRow r1 in OrderSKU.Rows)
                {
                    ...
                    if (r1["skuid"].ToString().Equals("371") || r1["skuid"].ToString().Equals("373") || r1["skuid"].ToString().Equals("390") || r1["skuid"].ToString().Equals("391"))
                    {
                        stc = stc.Replace("@0", "1");
                    }
                    else
                ...
                //{
                //    if (PaymentPlanSKU.Contains("371") || PaymentPlanSKU.Contains("373"))
                //    {
                ...
                {
                    if (PaymentPlanSKU.Contains("390") || PaymentPlanSKU.Contains("391"))
                    {
                        s1 = s1.Replace("@methodcode@", "1");
                    }
                    else
       ...
       public void RejectedOrdersCheck()
        ...
        public static void sendDeclineEmail(string DeclineToEmail, string FirstName, string LastName, string version)
        {
            ...
            sb.Append("Please visit our Website (http://www.trynono.com/ireland) and place an order with a new card.<br /><br />");
