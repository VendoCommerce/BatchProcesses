...
{
    public class Ireland : Com.ConversionSystems.UI.BasePage
    {
        ...
        private DataTable Orders
        {
            get
            {
                   //DAL.SQLServerDALUK.GetOrdersForXMLBatch(DateTime.ParseExact (DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd",CultureInfo.InvariantCulture), out _dtOrders);
                     DAL.SQLServerDALIreland.GetOrdersForXMLBatch(out _dtOrders);
        ...
        private DataTable RejectedOrders
        {
            get
            {
                ...
                {
                    //DAL.SQLServerDALUK.GetOrdersForXMLBatch(DateTime.ParseExact (DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd",CultureInfo.InvariantCulture), out _dtOrders);
                    DAL.SQLServerDALIreland.GetRejectedOrdersForXMLBatch(out _dtRejectedOrders);
                    //DAL.SQLServerDALUK.GetOrdersForXMLBatch(DateTime.Now.AddDays(-1), out _dtOrders);
                    //DAL.SQLServerDALUK.GetOrdersForXMLBatch(new DateTime(2009, 06, 29), out _dtOrders);
                }
        ...
        private DataTable CustomerBillingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDALIreland.GetCustomerAddress(_intBillingAddress, out _dtCustomerBillingAddress);
                }
        ...
        private DataTable CustomerShippingAddress
        {
            get
            {
                ...
                {
                    DAL.SQLServerDALIreland.GetCustomerAddress(_intShippingAddress, out _dtCustomerShippingAddress);
                }
        ...
        private DataTable OrderSKU
        {
            get
            {
                if (_dtOrderSKU == null)
                {
                    DAL.SQLServerDALIreland.GetOrderSKU(_intOrderID, out _dtOrderSKU);
                }
                return _dtOrderSKU;
            }
        }
        ...
        public string getomxml(string verifyflag, string orderid1, string creditCardName)
        {
            ...
            if (creditCardName.ToLower().Equals("lasercard"))
            {
                ...
                if (PaymentPlanSKU.Contains("390") || PaymentPlanSKU.Contains("391") || PaymentPlanSKU.Contains("392") || PaymentPlanSKU.Contains("400") || PaymentPlanSKU.Contains("561") || PaymentPlanSKU.Contains("562")
                    || PaymentPlanSKU.Contains("672")
                    || PaymentPlanSKU.Contains("673")
                    )
                {
                ...
                {
                    s1 = s1.Replace("@keyCode@", ds80.Tables[0].Rows[0].ItemArray[0].ToString());
                }
            }
            else
            {
        ...
        public void sendxml1(string verifyflag, string ordernumber)
        {
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                ...
                s1 = s1.Replace("@orderid@", "IE" + fixstring(r["orderid"]));
                ...
                foreach (DataRow r1 in OrderSKU.Rows)
                {
                    ...
                    if (r1["skuid"].ToString().Equals("371") || 
                        r1["skuid"].ToString().Equals("373") || 
                        r1["skuid"].ToString().Equals("390") || 
                        r1["skuid"].ToString().Equals("391") || 
                        r1["skuid"].ToString().Equals("413") || 
                        r1["skuid"].ToString().Equals("414") || 
                        r1["skuid"].ToString().Equals("417") || 
                        r1["skuid"].ToString().Equals("418") || 
                        r1["skuid"].ToString().Equals("543") || 
                        r1["skuid"].ToString().Equals("545") ||
                        r1["skuid"].ToString().Equals("561") ||                         
                        r1["skuid"].ToString().Equals("547") ||
                        r1["skuid"].ToString().Equals("672") ||

                        r1["skuid"].ToString().Equals("714") ||
                        r1["skuid"].ToString().Equals("716") ||
                        r1["skuid"].ToString().Equals("718") ||
                        r1["skuid"].ToString().Equals("720") ||
                        r1["skuid"].ToString().Equals("751") ||
                        r1["skuid"].ToString().Equals("722") ||
                        r1["skuid"].ToString().Equals("724") ||
                        r1["skuid"].ToString().Equals("726")  ||
                        r1["skuid"].ToString().Equals("781") ||
                        r1["skuid"].ToString().Equals("792")  
                        )
                    {
                        stc = stc.Replace("@0", "1");
                    }
                ...
                if (dsCountry.Tables[0].Rows[0]["Code"].ToString().ToLower().Equals("ie"))
                {
                    if (PaymentPlanSKU.Contains("390") || PaymentPlanSKU.Contains("391") || PaymentPlanSKU.Contains("561") || PaymentPlanSKU.Contains("672")
                        || PaymentPlanSKU.Contains("714")
                        || PaymentPlanSKU.Contains("716")
                        || PaymentPlanSKU.Contains("718")
                        || PaymentPlanSKU.Contains("720")
                        || PaymentPlanSKU.Contains("751")
                        || PaymentPlanSKU.Contains("722")
                        || PaymentPlanSKU.Contains("724")
                        || PaymentPlanSKU.Contains("726")
                        || PaymentPlanSKU.Contains("781")
                        || PaymentPlanSKU.Contains("792")
                    ...
                    if (PaymentPlanSKU.Contains("543") || PaymentPlanSKU.Contains("544") || PaymentPlanSKU.Contains("545") || PaymentPlanSKU.Contains("546") || PaymentPlanSKU.Contains("547") || PaymentPlanSKU.Contains("548"))
                    {
                        s1 = s1.Replace("@methodcode@", "5");
                    }
                    else if (PaymentPlanSKU.Contains("413") || PaymentPlanSKU.Contains("414") || PaymentPlanSKU.Contains("415") || PaymentPlanSKU.Contains("416") || PaymentPlanSKU.Contains("417") || PaymentPlanSKU.Contains("418") || PaymentPlanSKU.Contains("419") || PaymentPlanSKU.Contains("420") || PaymentPlanSKU.Contains("563") || PaymentPlanSKU.Contains("564") || PaymentPlanSKU.Contains("565") || PaymentPlanSKU.Contains("566"))
                    {
       ...
       public void RejectedOrdersCheck()
        ...
        public static void sendDeclineEmail(string DeclineToEmail, string FirstName, string LastName, string version)
        {
            ...
            sb.Append("Please visit our Website (http://www.trynono.ie) and place an order with a new card, or call 01 246 7806 to place an order by phone<br /><br />");
