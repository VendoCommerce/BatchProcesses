...
{
    public class SQLServerDALGermany : SQLServerDAO
    {
        SqlConnection _Connection = null;
        private const string _FILENAME = "SQLServerDALGermany.cs";
        ...
        public bool GetOrdersForXMLBatch(out DataTable dt)
        {
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "GetGermanyOrders";
        ...
        public bool GetRejectedOrdersForXMLBatch(out DataTable dt)
        {
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "GetIrelandRejectedOrders";
                oCmd.CommandType = CommandType.StoredProcedure;
