...
{
    public class SQLServerDALNeovaRemarketing : SQLServerDAO
    {
        SqlConnection _Connection = null;
        private const string _FILENAME = "SQLServerNeovaRemarketing.cs";
        ...
        public bool GetOrdersForXMLBatch(out DataTable dt)
        {
            ...
            try
            {
                intPhase = 0;
                oCmd = new SqlCommand();
                oCmd.CommandText = "GetOrdersForNeovaRemarketing";
        ...
        public SqlConnection Connection
        {
            ...
            get
            {
                ...
                try
                {
                    this.ClearErrors();
                    intPhase = -1;
                    if (_Connection == null) { _Connection = new SqlConnection(Helper.SQLServerDAO["Neova"].ToString()); }
                    intPhase = -2;
