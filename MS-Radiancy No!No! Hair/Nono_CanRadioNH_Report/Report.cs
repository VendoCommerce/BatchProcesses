...
using NONORADIOREPORT.com.hitslink.www;
    ...
    class Report 
    {
        ...
        public void SendEmailToAdmin(string ErrorMessage)
        {
            try
            {
                ...
                _sbEmailMessageBody.Append("<tr><td><b>Trynono.Com - Hybrid Media Report Batch :</b></td></tr>");
                ...
                MailMessage _oMailMessage = new MailMessage(fromEmail, AdminEmail, "Trynono.Com - Hybrid Media Report Generation Status", _sbEmailMessageBody.ToString());
        ...
        private static bool SendFileasAttachment(string txtFileName, string fileNameOnly, string date)
        {
            ...
            try
            {
                ...
                message.Subject = "Hybrid Media Radio Report - Week Ending" + date;
        ...
        private void LoadReport(DateTime ReportDate, int versionID, string VersionName , string FileName_PostFix)
        {
            try
            {
                ...
                DateTime StartDate = StartOfDay(ReportDate.AddDays(-7));                
                DateTime Enddate = EndOfDay(ReportDate);

             
                                           
                string txtFileName = Enddate.ToString("yyyyMMdd") + "_trynono_orders"+FileName_PostFix + ".csv";
                string txtFileName1 = Enddate.ToString("yyyyMMdd") + "_trynono_hybridmedia"+FileName_PostFix + ".csv";
                ...
                siteURL.Add("nonoinfo.com");
                siteURL.Add("nonoheadline.com");
                siteURL.Add("nonomsnews.com");
                siteURL.Add("nonostars.com");
                siteURL.Add("nonoz100.com");
                siteURL.Add("nonoprokiis.com");
                siteURL.Add("nonoprokiss.com");
                ...
                using (StreamWriter sb = new StreamWriter(FUllPAthwithFileName1))
                {
                    ...
                    try
                    {
                        for (DateTime date = StartDate; date <= Enddate; date = date.AddDays(1.0))
                        {
                            ...
                            DataTable DT = getDataTable("pr_report_order_version_detail_proradiocan", GetEastCoastStartDate(date), GetEastCoastDate(date), versionID);
                            // logic here
                        ...
                        foreach (string URl in siteURL)
                        {
                            ...
                            hline = "";
                            hline += date.ToShortDateString()+ ",";
                            hline += URl + ",";
                            if (HitLinkVisitor.ContainsKey(URl))
                            {
                                hline += HitLinkVisitor[URl].ToString() + ",";
                            }
                            else
                            {
                                hline += "0" + ",";
                            ...
                            {
                                if (row["URL"].ToString().ToLower().Equals(URl))
                                {
            ...
            {
                Console.WriteLine("Error Hybrid  Media Report " + ex.Message);
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Start Hybrid  Media Reports trynono.com " + ReportDate.ToString());
            Report DailyReports = new Report();
            DailyReports.LogToFile("Start Hybrid  Media Reports " + DateTime.Now.ToString());                                    
            ...
            Console.WriteLine("End  Hybrid  Media Reports trynono.com");
