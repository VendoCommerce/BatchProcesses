               ...
               foreach (DataRow _drOrder in Orders.Rows)
                {
                   ...
                   _intShippingAddress = Helper.ToInt32(_drOrder["CustomerShippingAddressId"].ToString());
                            ...
                            else if (_drOrder["BankAccountName"].ToString().ToLower().Contains("/h2/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/pt1/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/h3/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/h4/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/ps_h2/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/ps_h3/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/ps_h4/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/triple_g1/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/triple_g2/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/ps_triple_g1/") || _drOrder["BankAccountName"].ToString().ToLower().Contains("/ps_triple_g2/"))
                            {
